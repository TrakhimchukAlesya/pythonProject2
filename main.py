...
if HEROKU_APP_NAME is None:  # pooling mode
    ...
    print(f"Running bot in webhook mode. Make sure that this url is correct: https://{'bothackatonkaka1'}.herokuapp.com/")
    updater.start_webhook(
        listen="0.0.0.0",
        port=PORT,
        url_path=TELEGRAM_TOKEN,
        webhook_url=f"https://{'bothackatonkaka1'}.herokuapp.com/{'5414267140:AAFBz-5aqaqriqfpgRKddi-ZSDq0UMHjA0s'}"
    )
